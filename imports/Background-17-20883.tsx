import svgPaths from "./svg-ipry7klt17";
...
function Container() {
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[11.3391px] text-blue-100">
        <p className="block leading-[17.5px] text-nowrap whitespace-pre">
          Shift scheduled today at Smartlinx Healthcare
        </p>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-3.5 items-start justify-start pb-4 pl-8 pr-6 pt-6 relative w-full">
          <Container />
        </div>
      </div>
    </div>
...
function ArrowDropDownFilled() {
  return (
    <div
      className="absolute right-0 size-6 top-1/2 translate-y-[-50%]"
...
function Container1() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-center justify-start overflow-clip px-0 py-4 relative shrink-0 w-full"
      data-name="Container"
    >
      <MinHeight />
      <div
        className="basis-0 flex flex-col font-['Roboto:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#212121] text-[16px] text-left tracking-[0.15px]"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[24px]">Smartlinx Healthcare</p>
      </div>
      <MinWidth />
      <ArrowDropDownFilled />
    </div>
...
function LabelContainer() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#616161] text-[12px] text-left text-nowrap tracking-[0.15px]"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
...
function Input() {
  return (
    <div className="relative rounded shrink-0 w-full" data-name="Input">
      <div className="absolute border border-[rgba(33,33,33,0.05)] border-solid inset-0 pointer-events-none rounded" />
      <div className="relative size-full">
...
function Container2() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[15px] text-center text-nowrap">
        <p className="block leading-[20px] whitespace-pre">Punch In/Out</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div
      className="basis-0 bg-[#1976d2] grow h-[93px] min-h-px min-w-px relative rounded-lg shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1)] shrink-0"
      data-name="Button"
    >
      <div className="flex flex-col justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-1.5 h-[93px] items-start justify-center px-4 py-[7px] relative w-full">
          <Svg />
          <Container2 />
        </div>
      </div>
...
function Container3() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#1976d2] text-[15px] text-center text-nowrap">
        <p className="block leading-[20px] whitespace-pre">QR Punch</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div
      className="basis-0 bg-[#ffffff] grow h-[93px] min-h-px min-w-px relative rounded-lg shrink-0"
      data-name="Button"
    >
      <div className="flex flex-col justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-1.5 h-[93px] items-start justify-center px-4 py-2 relative w-full">
          <Svg1 />
          <Container3 />
        </div>
      </div>
...
function Container4() {
  return (
    ...
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#1976d2] text-[15px] text-center text-nowrap">
        <p className="block leading-[20px] whitespace-pre">Request Time Off</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    ...
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#1976d2] text-[15px] text-center text-nowrap">
        <p className="block leading-[20px] whitespace-pre">View Pay</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-[11px] items-start justify-center p-0 relative shrink-0 w-full"
      data-name="Container"
    >
      <Frame37382 />
      <Frame37383 />
